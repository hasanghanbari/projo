...
echo'
  <nav class="navbar navbar-expand-lg fixed-top navbar-light p-0" style="background-color: #0003;">
    ...
    <a class="btn btn-light drop-after-none dropdown-toggle btn btn-light" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <i class="fal fa-tasks-alt"></i> پروژه‌ها
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item m-1">
          <a class="btn btn-light drop-after-none dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
